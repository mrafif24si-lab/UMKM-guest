        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-white">100% Handmade Products</h4>
                    <h1 class="mb-5 display-3 text-white">Creative Products & Craft Items</h1>
                    <div class="position-relative mx-auto">
                        <input class="form-control border-2 border-white w-75 py-3 px-4 rounded-pill" type="text" placeholder="Search products...">
                        <button type="submit" class="btn btn-secondary border-2 border-white py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;">Search Now</button>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="banner-item text-center rounded p-4" style="background-color: var(--white);">
                        <h4 class="text-primary">Fresh Apples</h4>
                        <h5 class="text-secondary">20% OFF</h5>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner-item text-center rounded p-4" style="background-color: var(--white);">
                        <h4 class="text-primary">Produk yang</h4>
                        <h5 class="text-secondary">Free delivery</h5>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner-item text-center rounded p-4" style="background-color: var(--white);">
                        <h4 class="text-primary">Exotic Vegetable</h4>
                        <h5 class="text-secondary">Discount 30$</h5>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0">Rp.12 k</p>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/susu gepuk.jpeg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/ps5.jpeg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/kue.jpg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/sembako.jpg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/tasrajut2.jpg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/f.jpg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
                                     ...
                                     <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('assets-guest/img/fruite-item-5.jpg') }}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Fruits</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Grapes</h4>
